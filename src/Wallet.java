 ...
 * as the private keys have been exported and can be imported into the new wallet.</p>
 *
...
public class Wallet {
    ...
    /** Key phrase */
    private static final String keyPhrase = "Whatever you want for a passphrase";
     ...
     */
    public Wallet(String dbName) throws WalletException {
        //
        ...
        try {
            ...
            throw new WalletException("Unable to load the JDBC driver");
        }
        //
    ...
    public void storeKey(ECKey key) throws WalletException {
        Connection conn = checkConnection();
        try {
            EncryptedPrivateKey encPrivKey = new EncryptedPrivateKey(key.getPrivKey(), keyPhrase);
            try (PreparedStatement s = conn.prepareStatement(
     ...
     * @throws      WalletException     Unable to get address list
     */
    public List<ECKey> getKeyList() throws WalletException {
        ...
        try {
            try (Statement s = conn.createStatement()) {
                ...
                while (r.next()) {
                    ...
                    BigInteger privKey = encPrivKey.getPrivKey(keyPhrase);
                    ECKey key = new ECKey(pubKey, privKey, creationTime, label!=null?label:"");
